...
MOCK_VENUES = {
    ...
    "london": [
        {
            ...
            "address": "127 Kensington High Street, London W8",
            "cuisine": "British",
            "rating": 4.8,
        },
        {
            "id": "demo_london_002",
            "name": "Spice Route",
            "address": "45 Brick Lane, London E1",
            "cuisine": "Indian",
            "rating": 4.6,
        },
        {
            ...
            "address": "88 Borough Market, London SE1",
            "cuisine": "Vegetarian",
            "rating": 4.7,
        },
    ],
    "new york": [
        ...
        },
        {
            ...
            "address": "156 Mulberry Street, New York, NY 10013",
            "cuisine": "Italian",
            "rating": 4.5,
        },
        {
...
class DemoAdapter(BaseAdapter):
    ...
    async def search(
        ...
        GET /venues?city={city}&date={date}&guests={party_size}
        """
        city_lower = city.lower()
        venues = MOCK_VENUES.get(city_lower, [])
        ...
        if cuisine:
            ...
            venues = [
                v for v in venues
                if cuisine_lower in v["cuisine"].lower()
            ]
    ...
    async def book(
        ...
        for city_venues in MOCK_VENUES.values():
            for v in city_venues:
                if v["id"] == restaurant_id:
                    venue_name = v["name"]
                    break
